...
- Ship as a native iPhone app suitable for App Store submission.
...
- Provide an auto-renewable StillWant Plus subscription through StoreKit 2 for ongoing premium insights and cross-device iCloud synchronization. StoreKit test products must make the purchase flow testable without App Store Connect credentials.
